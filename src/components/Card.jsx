...
const Card = ({ profile, onSwipe, style = {} }) => {
  ...
  return (
    ...
    >
      <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-pink-400 to-purple-500">
        <img
          src={profile.image}
          alt={profile.name}
